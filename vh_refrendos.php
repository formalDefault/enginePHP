...
include "config.php";
$pagina="Agregar refrendos";  

//CONFIGURACION DE PAGINA
$color_form="naranja";
$color_imprimir="naranja";
$color_botones="blanco";
$url="vh_refrendos.php";
$nomb_tabla="vh_refrendos";
$nombre_formulario="Refrendos";
$titulo_boton_agregar="Agregar refrendo";
$genera_reportes="si";
...
$array_variables = array(
  ...
  ,array("*Clave","clave","text","","","","onblur='this.value=this.value.toUpperCase()' required","4","VARCHAR (20)","NOT NULL","si","","","")
  ,array("*Monto","monto","number","","",""," min='0' step='0.01'","4","DOUBLE","NOT NULL","si","","","") 
